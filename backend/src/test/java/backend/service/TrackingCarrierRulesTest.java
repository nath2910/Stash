...
class TrackingCarrierRulesTest {
  ...
  void infersSupportedCarrierFamiliesWithChronopostPriorityOverFrUpuFallback() {
    ...
    Assertions.assertEquals("chronopost", TrackingCarrierRules.inferSupportedCarrier("XW496078433TS"));
  ...
  void validatesCarrierSpecificFormats() {
    ...
    Assertions.assertFalse(TrackingCarrierRules.isValidForCarrier("05308083313940F", "chronopost"));
  }
