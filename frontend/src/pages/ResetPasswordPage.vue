          ...
          <div>
            ...
            <div class="relative mt-2">
              <input
                ...
                v-model="newPassword"
                required
                class="block w-full rounded-xl border border-slate-700 bg-slate-900/70 px-4 py-3 pr-20 text-sm text-slate-100 shadow-sm transition focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400"
              />
              <button
                type="button"
